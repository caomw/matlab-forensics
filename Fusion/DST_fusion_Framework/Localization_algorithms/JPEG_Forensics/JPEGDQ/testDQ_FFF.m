...
% JPEGqualities1 = [55 90];
% JPEGqualities2 = [55 90];
if ispc
    outputfoldername = 'output/FFF';
%     origfoldername='\\GIOTTO\Images\Prove\Bianchi\JPEGNA';
    addpath('../JPEGNA');
else
    outputfoldername = '/images/Prove/Bianchi/JPEGDQ/output/FFF';
...
save testDQoutputFFF_EM AUC FPmat TPmat AUC_s FPmat_s TPmat_s Q1err alpha_avg AUC_c FPmat_c TPmat_c
% AUC
