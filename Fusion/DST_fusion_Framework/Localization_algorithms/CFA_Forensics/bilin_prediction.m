% predizione di un filtro bilineare

function [residuo]=bilin_prediction(immagine,Bayer_R,Bayer_G,Bayer_B,N)
...
predizione_interpolati=interpolati-double(filtro_bilineare(acquisiti,Bayer_R,Bayer_G,Bayer_B));
predizione_acquisiti=acquisiti-double(filtro_bilineare(interpolati,1-Bayer_R,1-Bayer_G,1-Bayer_B));
