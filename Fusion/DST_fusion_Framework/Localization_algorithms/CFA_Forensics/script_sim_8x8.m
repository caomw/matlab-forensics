...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%
%%% Calcolo ROC per dimensioni della statistica 8x8
%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Generazione dei dati sui quali effettuare le misure
    for i=3:20
failures = main_dataset_bil_ZM(['/users/ferrara/Desktop/Dataset/',char(cartelle(i))],['/users/ferrara/Desktop/Simulazioni8x8/',char(cartelle(i))],Nb,TOL,MAX_ITER);
         verosimiglianza(['/users/ferrara/Desktop/Simulazioni8x8/',char(cartelle(i))]);
         ROC_verosimiglianza8x8(['/users/ferrara/Desktop/Simulazioni8x8/',char(cartelle(i))],tamper_size(i));
    end
