...
function [failures] = main_dataset_Nikon_bil_ZM(folder_name1,folder_name, Nb, tol, max_iter)
...
directory = dir( ['/users/ferrara/Desktop/Simulazioni/Dataset Nikon D90/',folder_name1,'/Dataset/*.*']); % formato cambia a seconda che siano jpg o tif
...
for i=3:length(files)
       ...
       % waitbar(i/(length(files)));
        ...
        filename = ['/users/ferrara/Desktop/Simulazioni/Dataset Nikon D90/', folder_name1,'/Dataset/',current_file];
