...
DatasetList={'ColumbiauUncomp','FirstChallengeTrain', 'Carvalho', 'FirstChallengeTest2','VIPPDempSchaReal','VIPPDempSchaSynth'};
            ...
            for subfolder=1:length(InputPaths);
                ...
                for fileInd=1:length(FileList)
                    ...
                    if ~exist(OutputName)
                        ...
                        [Result.estVDCT, Result.estVHaar] = GetKurtNoiseMaps(im);
