...
function [residuo]=gradientbased_prediction(immagine,Bayer_R,Bayer_G,Bayer_B,N)
...
predizione_interpolati=interpolati-filtro_gradientbased(acquisiti,Bayer_R,Bayer_G,Bayer_B);
predizione_acquisiti=acquisiti-filtro_gradientbased(interpolati,Bayer_R,Bayer_G,Bayer_B);
