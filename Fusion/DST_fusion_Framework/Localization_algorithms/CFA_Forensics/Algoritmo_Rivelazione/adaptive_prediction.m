...
function [residuo]=adaptive_prediction(immagine,Bayer_R,Bayer_G,Bayer_B,N)
...
predizione_interpolati=interpolati-filtro_adaptive(acquisiti,Bayer_R,Bayer_G,Bayer_B);
predizione_acquisiti=acquisiti-filtro_adaptive(interpolati,1-Bayer_R,1-Bayer_G,1-Bayer_B);
