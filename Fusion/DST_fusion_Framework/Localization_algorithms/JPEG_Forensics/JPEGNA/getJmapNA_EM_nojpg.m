function [LLRmap, LLRmap_s, q1table, k1e, k2e, alphatable] = getJmapNA_EM_nojpg(im,c2)
...
Y = ibdct(coeffArray+128);
I(:,:,1) = (Y + 1.402 * double(Cr - 128));
I(:,:,2) = (Y - 0.34414 *  double(Cb - 128) - 0.71414 * double(Cr - 128));
I(:,:,3) = (Y + 1.772 * double(Cb - 128));
E = I - double(uint8(I));
