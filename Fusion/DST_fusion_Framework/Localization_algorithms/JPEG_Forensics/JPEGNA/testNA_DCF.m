...
JPEGqualities1 = 50;
JPEGqualities2 = [90 95];
if ispc
%     outputfoldername = 'output/DCF/car';
    outputfoldername='\\GIOTTO\Images\Prove\Bianchi\JPEGNA\output\DCF';
else
    outputfoldername = '/images/Prove/Bianchi/JPEGNA/output/DCF';
...
%                 if c == 1
%                     imagesc(-maskTampered, [-100 100]), axis square
...
% save testNAoutputDCF_EM AUC FPmat TPmat AUC_s FPmat_s TPmat_s Q1err kkerr alpha_avg
AUC
figure, plot(squeeze(FPmat(1,1,1,:)), squeeze(TPmat(1,1,1,:))), axis square
figure, plot(squeeze(FPmat(3,1,1,:)), squeeze(TPmat(3,1,1,:))), axis square
figure, plot(squeeze(FPmat(5,1,1,:)), squeeze(TPmat(5,1,1,:))), axis square
