...
% Generazione dei dati sui quali effettuare le misure
    ...
    for i=4:6
         failures = main_dataset_v2(['/users/ferrara/Desktop/simulazioni camere/',char(cartelle(i))],Nb,TOL,MAX_ITER);
         verosimiglianza(['/users/ferrara/Desktop/simulazioni camere/',char(cartelle(i))]);
         ROC_verosimiglianza8x8(['/users/ferrara/Desktop/simulazioni camere/',char(cartelle(i))],tamper_size);
    end
