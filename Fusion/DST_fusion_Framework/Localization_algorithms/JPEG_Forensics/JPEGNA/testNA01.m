...
% JPEGqualities1 = round(63:50/16:74);
% JPEGqualities1 = round(75:50/16:87);
% JPEGqualities1 = round(88:50/16:99);
JPEGqualities2 = round(50:50/16:99);
...
% 
%             LLRmap = getJmapNA_EM(im, 1, c2Y(end), k1e, k2e);
%             
% %             figure
%             for c = 1:length(c2Y)
%                 maskTampered = smooth_unshift(sum(LLRmap(:,:,1:c),3),k1e,k2e);
...
iii
iii / (length(JPEGqualities1) * length(JPEGqualities2))
NNtot
PNtot
...
% end
% 
% save testNAoutputDCF01 AUC FPmat TPmat
% % AUC
