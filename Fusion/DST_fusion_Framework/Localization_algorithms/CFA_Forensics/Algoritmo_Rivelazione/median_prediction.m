...
function [residuo] = median_prediction(immagine,Bayer_R,Bayer_G,Bayer_B,N)
...
predizione_interpolati=interpolati-double(filtro_mediana(acquisiti,Bayer_R,Bayer_G,Bayer_B));
predizione_acquisiti=acquisiti-double(filtro_mediana(interpolati,Bayer_Rf,1-Bayer_G,Bayer_Bf));
