function [maskTampered, q1table, alphatable, msetable, nztable] = getJmap_stat(image,ncomp,c1,c2)
...
%     pause
    ...
    nztable(floor((coe-1)/8)+1,mod(coe-1,8)+1) = sum(num4Bin(lidx)) / numel(coeffFreq);
