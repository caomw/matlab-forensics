...
List=[];
List=[getAllFiles('/media/marzampoglou/New Volume/markzampoglou/ImageForensics/Datasets/Mark - Real World Splices/Extended and Refined Search/SubmarineMissile/Direct/','*.jpg',true)];
