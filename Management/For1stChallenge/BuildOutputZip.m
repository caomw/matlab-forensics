...
zip([strrep(OutputDir, [AlgorithmName '_' num2str(Quality) '_' num2str(MaskInd) '_' num2str(MaskThreshold) '_' num2str(CloseR) '_' num2str(OpenR) '_' num2str(Close2R) '/'],'') 'Subm_' AlgorithmName '_' num2str(Quality) '.zip'],[OutputDir '*.png']);
