...
DataPath={ColumbiauUncomp.au, ColumbiauUncomp.sp, VIPPDempSchaReal.au, VIPPDempSchaReal.sp, VIPPDempSchaSynth.au, VIPPDempSchaSynth.sp, FirstChallengeTrain.Sp, FirstChallengeTrain.Au, FirstChallengeTest2.Sp}; %, FirstChallengeTest.Sp
OutNames={'ColumbiauUncomp_au.mat', 'ColumbiauUncomp_sp.mat', 'VIPPDempSchaReal_au.mat', 'VIPPDempSchaReal_sp.mat', 'VIPPDempSchaSynth_au.mat', 'VIPPDempSchaSynth_sp.mat', 'FirstChallengeTrain_sp.mat','FirstChallengeTrain_au.mat', 'FirstChallengeTest2_sp.mat'}; %'FirstChallengeTest_sp.mat', 
...
for Quality=JPEG_Qualities(1)
    for FolderInd=6
        ...
        for ii=3960:min(length(List),upLimit)
            if mod(ii,15)==0
                disp(ii);
            end
    ...
    for FolderInd=7:length(DataPath)
        %DataPath{FolderInd}=strrep(DataPath{FolderInd},'\','/');
